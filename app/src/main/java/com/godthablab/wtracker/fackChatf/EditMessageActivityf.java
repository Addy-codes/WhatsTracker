...
public class EditMessageActivityf extends AppCompatActivity implements OnClickListener {
    String chatid;
    ...
    private class btnSendUserListner implements OnCheckedChangeListener {
        public void onCheckedChanged(RadioGroup group, int checkedId) {
            if (checkedId == R.id.me) {
                EditMessageActivityf.this.sender = "yes";
                return;
            }
            EditMessageActivityf.this.sender = "no";
        }
    }
    ...
    private class btnMessageStatusListner implements OnCheckedChangeListener {
        public void onCheckedChanged(RadioGroup group, int checkedId) {
            if (checkedId == R.id.send) {
                EditMessageActivityf.this.status = "send";
            } else if (checkedId == R.id.receive) {
                EditMessageActivityf.this.status = "receive";
            } else {
                EditMessageActivityf.this.status = "read";
            }
        }
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.delete_usermessage:
                this.databaseHelperf.DeleteMessage(this.chatid);
                Intent editmessageintent = new Intent(this, UserChatf.class);
            ...
            case R.id.edit_usermessage:
                ...
                this.databaseHelperf.UpdateMessageDetails(this.chatid, this.sender, this.message, this.status);
                Intent intent = new Intent(this, UserChatf.class);
                ...
                return;
            case R.id.menu:
                Intent intentback = new Intent(this, UserChatf.class);
