...
public class Wallpaperf extends AppCompatActivity implements OnClickListener {
    ...
    private class btnUserSavPhotoListner implements OnClickListener {
        public void onClick(View view) {
            Wallpaperf.this.startActivityForResult(new Intent("android.intent.action.PICK", Media.EXTERNAL_CONTENT_URI), 101);
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserChatf.tokenname = this.prefs.getString("IMAGE", "");
        if (UserChatf.tokenname.equals("")) {
            ivUserSavedPhoto.setImageResource(R.drawable.default_background);
        } else {
            selectedImageUri = Uri.parse(UserChatf.tokenname);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.backmenu:
                Intent backintent = new Intent(this, UserChatf.class);
            ...
            case R.id.newimage:
                try {
                    UserChatf.tokenname = selectedImageUri.toString();
