...
public class EditChatUserProfilef extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.edit_chat_user_profilef);
    ...
    private void GetCurrentUserDetails() {
        Cursor c = this.databaseHelperf.getUserHistory(this.user_id + "");
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.delete_userProfile:
                this.databaseHelperf.DeleteUserProfile(this.user_id);
            ...
            case R.id.edit_userProfile:
                ...
                this.databaseHelperf.getUserDetailsUpdate(this.user_id, uname, status, isonline, istyping, this.bmyimage);
