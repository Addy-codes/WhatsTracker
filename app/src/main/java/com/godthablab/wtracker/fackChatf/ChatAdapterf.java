...
class ChatAdapterf extends BaseAdapter {
    ...
    public ChatAdapterf(Context context, ArrayList<String> messageArray, ArrayList<String> senderUser, ArrayList<String> time, ArrayList<String> msgstatuslist, ArrayList<String> ismessagetype, ArrayList<String> imagpath) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        @SuppressLint("ViewHolder") View rowView = inflater.inflate(R.layout.custlistviewf, null);
