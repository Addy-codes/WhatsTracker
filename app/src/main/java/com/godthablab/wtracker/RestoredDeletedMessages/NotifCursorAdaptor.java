...
/* NotifCursorAdaptor View Adapter For ListView
* Binds STUFF in List View. = binds views and binds data
*
*
* */
...
public class NotifCursorAdaptor extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return LayoutInflater.from(context).inflate(R.layout.list_item_resdelmsg, parent, false);
    }
