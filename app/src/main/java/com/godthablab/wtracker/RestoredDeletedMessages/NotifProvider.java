...
/*CONTENT PROVIDER FOR QUERING SQLITE DATABASE , INSERT , DELETE , UPDATE */
...
public class NotifProvider extends ContentProvider {
    ...
    @Nullable
    @Override
    public Cursor query(@NonNull Uri uri, @Nullable String[] tableColumns, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        SQLiteDatabase db = notifDbHelper.getReadableDatabase();
        Cursor cursor = db.query(   TABLE_NAME,tableColumns,selection,selectionArgs,null,null,sortOrder);
