...
import com.godthablab.wtracker.AppConfig;
import com.godthablab.wtracker.MySession;
import com.godthablab.wtracker.ParentalControl.SPHelpher.SessionManager;
...
import com.godthablab.wtracker.ParentalControl.server.Constants;
...
public class AddNumberFragment extends Fragment implements BillingProcessor.IBillingHandler {
    ...
    ImageView yearly,monthly,weeakly;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        yearly = (ImageView)view.findViewById(R.id.yearly);
        monthly = (ImageView)view.findViewById(R.id.monthly);
        weeakly = (ImageView)view.findViewById(R.id.weeakly);
...
//        }
        ...
        yearly.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d(TAG, "onClick: yearly");

                String premium = "yearly_subscription";
                bp.subscribe(getActivity(), premium);

                /*try {
                    // Retrieve a value for "skuDetails" by calling querySkuDetailsAsync().
                    BillingFlowParams billingFlowParams = BillingFlowParams.newBuilder().setSkuDetails(skuDetailsList.get(0))
                            .build();
        ...
        monthly.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String premium = "monthly_subscription";
                bp.subscribe(getActivity(), premium);
        ...
        weeakly.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Log.d(TAG, "onClick: yearly");

                String premium = "weekly_subscription";
                bp.subscribe(getActivity(), premium);
