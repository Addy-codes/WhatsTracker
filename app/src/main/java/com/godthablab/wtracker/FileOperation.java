...
public static boolean saveFileLocalDir(String filePath, int type) {
        ...
        switch (type) {
                case AssetType.TYPE_IMAGE :  dst = new File(C.WW_IMAGES,src.getName());
                                        break;
                case AssetType.TYPE_VIDEO:  dst = new File(C.WW_VIDEOS,src.getName());
                                        break;
                case AssetType.TYPE_GIF:  dst = new File(C.WW_GIF,src.getName());
                                        break;
                case AssetType.TYPE_STATUS_IMAGE:  dst = new File(C.WW_STATUS_IMAGES,src.getName());
                                        break;
                case AssetType.TYPE_STATUS_VIDEO: dst = new File(C.WW_STATUS_VIDEOS,src.getName());
                                        break;
